...
//
//        //val db: AppDatabase? = null  //Database
//
//    }
...
//            editor.apply()
//        }
//        val textView = findViewById(R.id.serieTitle)
//        textView.setText(seriesTitle)
//
//        val adapter = SeasonAdapter( seasonList)
//        val listView = findViewById(R.id.seasonListView)
//        listView.setAdapter(adapter)
//        listView.setOnItemClickListener(AdapterView.OnItemClickListener { parent, view, position, id ->
//            //Toast.makeText(SeasonActivity.this, "You Selected", Toast.LENGTH_SHORT).show();
//            //***********************
//            FLAG = 1
//            val seasonNo = adapter.getItem(position).getItemId()
